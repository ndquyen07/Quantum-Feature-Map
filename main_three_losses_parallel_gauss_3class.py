...
def main_parallel(run_id=0, depth=1, type_ansatz="RealAmplitudes", optimizer_name="COBYLA",
    ...
    X, y = make_gaussian_quantiles(mean=None, cov=0.5, n_samples=300, n_features=2, n_classes=3, random_state=42)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_samples", type=int, default=300, help="Total number of samples")
    parser.add_argument("--test_size", type=int, default=100, help="Test set size")
