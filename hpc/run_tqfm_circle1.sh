#!/bin/bash
#SBATCH --job-name=tqfm_1circle
#SBATCH --output=/data/%u/logs/tqfm_circle_%j.out
#SBATCH --error=/data/%u/logs/tqfm_circle_%j.err
...
python3.13 parallel_losses_circle1.py --run_id ${SLURM_ARRAY_TASK_ID} --depth 1 --ansatz EfficientSU2 --maxiter 2000
