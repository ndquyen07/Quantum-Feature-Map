...
class TrainingConfig:
    ...
    n_samples: int = 300
    test_size: int = 100
    results_dir: str = "/data/ndquyen/qfm/results_losses_gauss_3class"
...
def main_parallel(config: Optional[TrainingConfig] = None, **kwargs) -> tuple:
    ...
    # Generate data
    X, y = make_gaussian_quantiles(mean=None, cov=1.0, n_samples=200, n_features=2, n_classes=3, random_state=42)
