#!/bin/bash
#SBATCH --job-name=tqfm_1moon
#SBATCH --output=/data/%u/logs/tqfm_moon_%j.out
#SBATCH --error=/data/%u/logs/tqfm_moon_%j.err
...
python3.13 parallel_losses_moon1.py --run_id ${SLURM_ARRAY_TASK_ID} --depth 1 --ansatz EfficientSU2 --maxiter 2000
